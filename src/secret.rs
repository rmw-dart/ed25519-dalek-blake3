...
impl SecretKey {
  ...
  /// #
  /// use ed25519_dalek_blake3::SecretKey;
  /// use ed25519_dalek_blake3::SECRET_KEY_LENGTH;
...
impl<'a> From<&'a SecretKey> for ExpandedSecretKey {
  ...
  /// #
  /// use rand::rngs::OsRng;
  /// use ed25519_dalek_blake3::{SecretKey, ExpandedSecretKey};
  ///
  /// let mut csprng = OsRng{};
  /// let secret_key: SecretKey = SecretKey::generate(&mut csprng);
  ...
  fn from(secret_key: &'a SecretKey) -> ExpandedSecretKey {
    let mut h: Hasher = Hasher::default();
...
impl ExpandedSecretKey {
  ...
  /// # extern crate ed25519_dalek_blake3;
  /// #
  /// # use ed25519_dalek_blake3::{ExpandedSecretKey, SignatureError};
  /// #
  /// # #[cfg(feature = "std")]
